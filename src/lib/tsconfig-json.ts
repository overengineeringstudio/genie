...
export type TsconfigJSONArgs = (CompilerOptionsDefinition & CompileOnSaveDefinition & TypeAcquisitionDefinition & ExtendsDefinition & WatchOptionsDefinition & BuildOptionsDefinition & TsNodeDefinition & (FilesDefinition | ExcludeDefinition | IncludeDefinition | ReferencesDefinition))
/**
...
/**
 * Creates a TsconfigJSON configuration object
 * @param args TsconfigJSONArgs configuration options
 * @returns A properly formatted configuration object
 */
export const tsconfigJSON = (
    args: TsconfigJSONArgs,
): string => {
